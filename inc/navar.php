            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        ...
                        <a href="louisvuitton.html" class="nav-item nav-link">Louis vuitton</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" style="height: 610px;">
                            <img class="img-fluid" src="image/anh10.jpg" alt="Image">
                        ...
                        <div class="carousel-item" style="height: 610px;">
                            <img class="img-fluid" src="image/anh11.jpg" alt="Image" style="width:80%;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First
                                        Order</h4>
                        ...
                        <div class="carousel-item" style="height: 610px;">
                            <img class="img-fluid" src="image/anh6.jpg" alt="Image" style="width:80%;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First
                                        Order</h4>
                        ...
                        <div class="carousel-item" style="height: 610px;">
                            <img class="img-fluid" src="image/anh8.jpg" alt="Image" style="width:80%;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First
                                        Order</h4>
                        ...
                        <div class="carousel-item" style="height: 610px;">
                            <img class="img-fluid" src="image/anh3.jpg" alt="Image" style="width:80%;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First
                                        Order</h4>
                        ...
                        <div class="carousel-item" style="height: 610px;">
                            <img class="img-fluid" src="image/2.jpg" alt="Image" style="width:80%;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h4 class="text-light text-uppercase font-weight-medium mb-3">10% Off Your First
                                        Order</h4>
